        ...
        success: function (data) {
            ...
            $.each(data.data, function (idx, elem) {
                if(elem.company !== undefined && elem.cms !== undefined) {
                    ...
                    table.row.add([
                        elem.company.name,
                        elem.company.country,
                        elem.company.city ? elem.company.city : '',
                        elem.company.turnover,
                        elem.cms.name,
                        elem.cms.version,
                        elem.cms.domain,
                        divAction
...
function constructDataMap(array)
{
    ...
    $.each(array, function (idx, elem) {
        if(
            typeof elem.company !== "undefined" &&
            typeof elem.company.country !== "undefined" &&
            typeof elem.company.city !== "undefined" &&
            typeof elem.company.latitude !== "undefined" &&
            typeof elem.company.longitude !== "undefined"
        ) {
            if(typeof simplemaps_worldmap_mapdata['locations'] === "undefined") {
                simplemaps_worldmap_mapdata['locations'] = {};
            }

            if(typeof simplemaps_worldmap_mapdata['locations'][elem.company.city] === "undefined") {
                simplemaps_worldmap_mapdata['locations'][elem.company.city] = {
                    name: elem.company.country.toString()+', '+elem.company.city,
                    lat: elem.company.latitude.toString(),
                    lng: elem.company.longitude.toString(),
                    color: '#'+(Math.random()*0xFFFFFF<<0).toString(16),
                    description: elem.cms.name+' : 1',
                    cms: {
                        [elem.cms.name] : 1
                    }
                };
                ...
                simplemaps_worldmap_mapdata['locations'][elem.company.city]['description'] = description;
            }
        }
    });
